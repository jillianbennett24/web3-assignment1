                    ...
                    <div className="flex">
                        <div className="w-1/12 pr-4">
                            <div className="sticky top-0">
                                <Filters  sampleMovie={props.sampleMovie} filterRating={props.filterRating} filterYear={props.filterYear} searchForMovieTitle={props.searchForMovieTitle}  onGenreSelect={props.onGenreSelect} movies={props.movies} resetData={props.resetData}/>
                            </div>
                        </div>
