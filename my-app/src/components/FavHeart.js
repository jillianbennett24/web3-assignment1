...
const FavHeart = ({isFav}) => {
    if (isFav) {
        ...
        return (
            // empty heart
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 ml-2 hover:cursor-pointer text-green-500">
